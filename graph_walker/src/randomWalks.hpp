...
py::list randomWalksRestart(py::array_t<uint32_t> _indptr, py::array_t<uint32_t> _outdegrees, py::array_t<uint32_t> _indices, py::array_t<float> _data, py::array_t<uint32_t> _startNodes, uint32_t max_node_id, uint32_t num_edges, size_t nWalks, float alpha);
// py::array_t<uint32_t> randomWalksRestart(py::array_t<uint32_t> _indptr, py::array_t<uint32_t> _indices, py::array_t<float> _data, py::array_t<uint32_t> _startNodes, size_t nWalks, float alpha);
